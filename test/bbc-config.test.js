...
test("BBC hardware profiles filter compatible software presets", () => {
  ...
  assert.deepEqual(softwareForProfile("bbc-model-b-acorn-z80").map(({ id }) => id), ["acorn-cpm-utilities", "acorn-cpm-bbc-basic", "acorn-cpm-memoplan", "acorn-cpm-graphplan", "acorn-cpm-fileplan", "acorn-cpm-cis-cobol", "custom-acorn-cpm"]);
