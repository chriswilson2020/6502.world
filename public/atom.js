...
const ids = ["atomScreen", "atomRunState", "atomStatus", "bootAtomButton", "resetAtomButton", "atomBasicInput", "atomFloatInput", "atomKernelInput", "atomTextMirror", "atomPc", "atomCycles", "atomColumn", "atomSpeaker", "atomMode", "pauseAtomButton", "enableAtomAudioButton", "atomBreakpointCount", "atomBreakpointInput", "toggleAtomBreakpointButton", "stepAtomButton", "atomDisassembly", "exportAtomStateButton", "atomStateInput", "atomDebuggerStatus"];
