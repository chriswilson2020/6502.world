...
async function boot() {
  try {
    ...
    coreRoms = { basic, floatingPoint, kernel }; machine = new AcornAtom({ traceLimit: 128, accessLogLimit: 0 }); machine.loadCoreRoms(coreRoms); elements.atomTapePlay.disabled = true; elements.atomTapeRewind.disabled = true;
