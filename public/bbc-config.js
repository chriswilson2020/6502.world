...
export const BBC_SOFTWARE_PRESETS = Object.freeze({
  ...
  "acorn-cpm-accountant": Object.freeze({ id: "acorn-cpm-accountant", title: "Compact Accountant 1.0", profile: "bbc-model-b-acorn-z80", drives: Object.freeze([{ id: "accountant-start", path: "MEDIA/Start_Of_Day_Disc.dsd", filename: "Start_Of_Day_Disc.dsd", writeProtected: false }, { id: "accountant-data", path: "MEDIA/Accountant_Data_Disc.dsd", filename: "Accountant_Data_Disc.dsd", writeProtected: false }]), mediaPolicy: "replace", status: "validated", bootsCpm: true, launchSteps: Object.freeze([Object.freeze({ prompt: "A>", command: "START" })]), launchMarker: "COMPACT START OF DAY" }),
  "acorn-cpm-nucleus": Object.freeze({ id: "acorn-cpm-nucleus", title: "Compact Nucleus", profile: "bbc-model-b-acorn-z80", drives: Object.freeze([{ id: "nucleus-start", path: "MEDIA/Start_Of_Day_Disc.dsd", filename: "Start_Of_Day_Disc.dsd", writeProtected: false }, { id: "nucleus-parameter", path: "MEDIA/Nucleus_Parameter_File_Program_Disc.dsd", filename: "Nucleus_Parameter_File_Program_Disc.dsd", writeProtected: false }]), mediaPolicy: "replace", status: "validated", bootsCpm: true, launchSteps: Object.freeze([Object.freeze({ prompt: "A>", command: "START" })]), launchMarker: "COMPACT START OF DAY" }),
