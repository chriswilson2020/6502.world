...
export const BBC_SOFTWARE_PRESETS = Object.freeze({
  ...
  "acorn-cpm-utilities": Object.freeze({ id: "acorn-cpm-utilities", title: "Acorn CP/M 2.2 Utilities", profile: "bbc-model-b-acorn-z80", drives: Object.freeze([{ id: "cpm-utilities", path: "MEDIA/CPM_Utilities_Disc.dsd", filename: "CPM_Utilities_Disc.dsd", writeProtected: true }, null]), mediaPolicy: "replace", status: "validated", bootsCpm: true }),
  "acorn-cpm-bbc-basic": Object.freeze({ id: "acorn-cpm-bbc-basic", title: "BBC BASIC for Z80", profile: "bbc-model-b-acorn-z80", drives: Object.freeze([{ id: "cpm-utilities", path: "MEDIA/CPM_Utilities_Disc.dsd", filename: "CPM_Utilities_Disc.dsd", writeProtected: true }, { id: "bbc-basic-z80", path: "MEDIA/Basic_Program_Disc.dsd", filename: "Basic_Program_Disc.dsd", writeProtected: true }]), mediaPolicy: "replace", status: "validated", bootsCpm: true, launchSteps: Object.freeze([Object.freeze({ prompt: "A>", command: "B:" }), Object.freeze({ prompt: "B>", command: "BBCBASIC" })]), launchMarker: "Acorn BBC BASIC Version 2.20" }),
