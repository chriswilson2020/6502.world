...
| `basic1.rom` | 16K | `6dccf62d34a90fc16f102f9dbb3431bbf084e4edcbc21a5f059bbdf6af35b566` | BBC BASIC I; default language ROM for the Atom BBC BASIC conversion profile |
...
| `Atom_BBC_BASIC_OS.rom` | 4K | `8419bc5e8c39aaa72445754879ca15de2a7fca3e0334bb7852312537bc9f1112` | Atom BBC BASIC MOS variant 1 at `$F000-$FFFF`; paired with bundled BASIC I |
...
The browser fetches the BBC OS, BASIC, DNFS and Z80 images from this directory. Normal BBC startup remains BASIC; selecting the Z80 Tube processor restarts with DNFS in bank 14 and the bundled parasite firmware. The Atom machine layer uses the three checksum-pinned Atom core images. Its conversion-card profile pairs owner-supplied BASIC I with owner-supplied Atom BBC BASIC MOS variant 1 and boots without local files. The uploaded canonical BASIC 4 image is not bundled because it fails after the banner with this MOS variant. Local replacement images remain supported.
